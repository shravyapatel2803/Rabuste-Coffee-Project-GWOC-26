...
export const createOrder = async (req, res) => {
  try {
    const { 
      ...
      paymentStatus, razorpayOrderId, paymentId, signature, specialRequest 
    } = req.body;
    ...
    await logNotification({
      ...
      data: { amount: totalAmount, pickupTime: pickupTime }
    });
...
// get order admin side with filters
