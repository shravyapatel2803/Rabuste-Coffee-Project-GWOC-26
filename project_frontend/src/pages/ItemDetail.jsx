...
import { Loader2, ArrowLeft } from "lucide-react"; // Removed ShoppingBag
...
const ItemDetail = () => {
  ...
  if (!item) return <div className="text-rabuste-text text-center pt-32">Item not found</div>;

  return (
    // FIX: text-white -> text-rabuste-text for Light Mode visibility
      ...
      <div className="pt-32 px-6 max-w-6xl mx-auto pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
          ...
          <div className="relative group">
            ...
            {/* FIX: border-white/10 -> border-rabuste-text/10 */}
